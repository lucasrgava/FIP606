...
Nesse étodo selecionamos o padrão de distribuição dos dados na função para ajuste do modelo, e seguimos com a ANOVA e testes de comparações múltiplas.
...
Separando grupos pelo teste de comparações múltiplas.
...
Valores médios com IC. A sobreposição de intervalos é perceptível, o que condiz para não existir diferença entre os tratamentos, exceto, o entre os tratamentos 1 e 6.
...
Dados de um ensaio realizado em DIC, onde testou-se o efeito da utilização de dois tipos de irrigação sobre a severidade de doenças. Foram feitas avaliação aos 0, 7, 14, 21, 28, 35, 42, 49, 56 e 63 dias.
...
Não há diferença entre os tipos de irrigaçao sobre a AACPD.
